...
export default function HostInfo() {
    ...
    return (
        <div className='sticky top-0 rounded shadow-md m-8 mt-10 w-min bg-white h-fit right-0 '>
            <div className='flex flex-row'>
                ...
                <div className="flex items-center">
                    ...
                    <p className="ml-2 text-sm font-bold">[reviews.avg]</p>
                    <a href="#reviews" className="text-sm ml-2 font-medium text-gray-900 underline hover:no-underline">[reviews.length] reviews</a>
                </div>
            </div>
